							...
							<section class="tiles">
								...
								<article class=<?php echo "'style" . rand(1,6) . "'"; ?>>
									<span class="image jimg-350">
										<img src=<?php if ( empty ($row["imgArt1"]) ) 
											{
												echo "'" . (utf8_encode("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjgJGYMDLle3eIrq90fshGeXMpNeJXuJZJycHqszwAMOVPC-Nh")) . "'";
											}
										 	
										 	 	echo "'" . (utf8_encode($row["imgArt1"])) . "'"; 
										 	 										 	 ?> alt="" />
									</span>
